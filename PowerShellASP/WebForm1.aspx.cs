...
namespace PowerShellASP
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void  ExecuteInputClick(object sender, EventArgs e)
        {
            ...
            //InitialSessionState iss = InitialSessionState.CreateDefault();  //.CreateDefault2();
            ...
            //shell.Commands.AddCommand("Test-NetConnection");
            ...
            //shell.Commands.AddParameter("ComputerName", IP.Text); //.AddParameter("Port", PORT.Text);

            var shell = PowerShell.Create();
            shell.AddScript($"Test-NetConnection -ComputerName {IP.Text} -Port {PORT.Text} | out-string");
